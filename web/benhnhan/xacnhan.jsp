...
<section class="container mx-auto px-4 py-20">
    <div class="max-w-2xl mx-auto bg-white p-10 rounded-2xl shadow-lg">
        ...
        <div class="space-y-4 text-lg bg-gray-50 p-6 rounded-xl border">
            ...
            <!-- Ca khám -->
            <p><span class="font-semibold text-sky-700"><i class="fa-solid fa-clock me-2"></i>Ca khám:</span>
                <c:out value="${sessionScope.lichHenVuaDat.caKham.tenCa}"/> (
                <fmt:formatDate value='${sessionScope.lichHenVuaDat.caKham.gioBatDau}' pattern='HH:mm'/> -
                <fmt:formatDate value='${sessionScope.lichHenVuaDat.caKham.gioKetThuc}' pattern='HH:mm'/>
                )
            </p>
            ...
            <form action="${pageContext.request.contextPath}/ThanhToanServlet" method="post" class="text-center mt-10">
                <input type="hidden" name="action" value="confirm">
                <input type="hidden" name="lichHenId" value="${sessionScope.lichHenVuaDat.lichHenId}">
                <input type="hidden" name="soTien" value="${sessionScope.lichHenVuaDat.chiPhi}">
