...
public class ThanhToanDB {
    ...
    public static ThanhToan getById(int thanhToanId) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (phuongThucStr != null) {
                    thanhToan.setPhuongThuc(PhuongThuc.valueOf(phuongThucStr));
                }
                thanhToan.setMaGiaoDichVnpay(rs.getString("maGiaoDichVnpay"));
                return thanhToan;
            }
        } catch (SQLException ex) {
            Logger.getLogger(ThanhToanDB.class.getName()).log(Level.SEVERE, null, ex);
        ...
        return null;
            ...
            public static void updateTrangThai(int thanhToanId, String trangThai) {
            EntityManager em = DBUtil.getEmFactory().createEntityManager();
            EntityTransaction trans = em.getTransaction();
            try {
                trans.begin();
                ThanhToan thanhToan = em.find(ThanhToan.class, thanhToanId);
                if (thanhToan != null) {
                    thanhToan.setTrangThai(TrangThai.valueOf(trangThai));
                    em.merge(thanhToan);
                }
                trans.commit();
            } catch (Exception e) {
