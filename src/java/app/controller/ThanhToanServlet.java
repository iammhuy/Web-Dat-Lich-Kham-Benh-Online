            ...
            try {
                ...
                if (signValue.equals(vnp_SecureHash)) {
                    ...
                    if ("00".equals(vnp_ResponseCode)) {
                        ...
                        ThanhToan thanhToanInfo = ThanhToanDB.getById(thanhToanId);
                        request.setAttribute("thanhToanInfo", thanhToanInfo);
                        request.setAttribute("message", "Thanh toán thành công!");
                        //nhat huy them=====
                        int lichHenId = thanhToan.getLichHenId();
                        request.setAttribute("lichHenId", lichHenId); // <-- thêm dòng này
                        //=======================
